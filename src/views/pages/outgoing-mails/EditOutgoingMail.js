...
const EditOutgoingMail = () => {
  ...
  const updateOutgoingMail = async (e) => {
    ...
    if (outgoingMail.subject !== "") {
      dispatch(editMail(updMail.id, outgoingMail));
    }
  };
  ...
  useEffect(() => {
    if (mail) {
      ...
      setOutgoingMail({
        ...
        date_sent: new Date(mail.date_sent).toISOString().substring(0, 10),
      });
    }
  }, [mail]);
  ...
  return (
    <div className="content-wrapper">
      ...
      <div className="row m-0 p-0">
        <div className="pt-2 col-sm-9 col-md-9 text-center m-auto">
        ...
        <div className="col-sm-9 col-md-6 mx-auto">
          <div className="card card-primary">
            <div className="card-header">
              <h3 className="card-title">Edit Outgoing Mail</h3>
            </div>
            {/* /.card-header */}

            {/* form start */}
            <form method="post" onSubmit={updateOutgoingMail}>
